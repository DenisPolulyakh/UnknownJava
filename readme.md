...
# Аннотации
 - #### [1. Маркерный интерфейс](#маркерный-интерфейс-1)
 - #### [1.3 Ключевые моменты](#ключевые-моменты-1)
 - #### [2. Анатомия аннотации](#анатомия-аннотации-1)
 - #### [3. Классификация аннотаций](#классификация-аннотаций-1)
